...
public class SNavigationDrawer extends RelativeLayout{
    ...
    //Layouts
    protected List<MenuItemClass> menuItemList;
    ...
    private int appbarColor = R.color.RoyalBlue;
    private int appbarTitleTextColor = R.color.Black;
    private int menuItemSemiTransparentColor = R.color.transparent_black_percent_55;
    ...
    private float appbarTitleTextSize = 30;
    ...
    public void init(Context context){
        ...
        menuItemList = new ArrayList<MenuItemClass>();
    ...
    protected void setAttributes(TypedArray attrs){
        ...
        setAppbarTitleTextSize(attrs.getDimension(R.styleable.SNavigationDrawer_appbarTitleTextSize,30));
    ...
    public void addMenuItem(MenuItemClass menuItem){
    ...
    public List<MenuItemClass> getMenuItemList() {
        return menuItemList;
    }

    //Setting the list of Menu Items
    public void setMenuItemList(List<MenuItemClass> menuItemList) {
